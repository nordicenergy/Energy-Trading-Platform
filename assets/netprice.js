...
var chart = AmCharts.makeChart("chartdiv", {
    ...
    "theme": "dark",
    "dataLoader": {
        "url": "https://forkdelta.app/#!/trade/0x4d0a4c762bd7f742096daaf5911dcf9c94b9ea95-ETH",
        "format": "json",
        "reload": 30,
        "postProcess": function (data) {
            ...
            document.getElementById('NETPrice1').innerHTML = tmpv;
            document.getElementById('NETPrice2').innerHTML = tmpv;
...
var buynet = 0;
var oldVal = "";
//예전 jQueryRamen not not bind나 live
$("#ordercount").on("change keyup paste", function () {
    ...
    if (isNaN(currentVal) == true) {
        ...
        buynet = tmp;
        buynet2 = buynet * dollar;
        $("#orderprice").val(buynet + " NET");
        document.getElementById('infoo').innerHTML = "$" + buynet2;
    }
