...
var chart = AmCharts.makeChart("chartdiv", {
    ...
    "theme": "dark",
    "dataLoader": {
        "url": "https://poloniex.com/public?command=returnOrderBook&currencyPair=USDT_EOS&depth=50",
        "format": "json",
        "reload": 30,
        "postProcess": function (data) {
            ...
            document.getElementById('EOSPrice1').innerHTML = tmpv;
            document.getElementById('EOSPrice2').innerHTML = tmpv;
...
$("#ordercount").on("change keyup paste", function () {
    ...
    if (isNaN(currentVal) == true) {
        ...
        buyeos = tmp;
        buyeos2 = buyeos * dollar;
        $("#orderprice").val(buyeos + " EOS");
        document.getElementById('infoo').innerHTML = "$" + buyeos2;
    }
